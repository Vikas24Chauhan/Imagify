...
function Description() {
  return (
    <div className="flex flex-col items-center justify-center mt-24 md:px-28">
      ...
      <div className="flex flex-col gap-5 md:gap-14 md:flex-row items-center">
        <img className="w-85 rounded-lg" src={assets.sample_img_1} alt="" />
        <div>
          <h2 className="text-3xl font-medium max-e-lg mb-4">
